...
def getRecords(sex, indoor=False):
    ...
    df = df.sort_values(['discipline', 'date'], ascending=[True, True])
...
menOutdoorRecords.to_csv('worldrecords/menOutdoorRecords.csv', index=False)
womenOutdoorRecords.to_csv('worldrecords/womenOutdoorRecords.csv', index=False)
menIndoorRecords.to_csv('worldrecords/menIndoorRecords.csv', index=False)
womenIndoorRecords.to_csv('worldrecords/womenIndoorRecords.csv', index=False)
